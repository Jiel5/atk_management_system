...
return new class extends Migration
{
    ...
    {
        Schema::table('pengeluaran_atk', function (Blueprint $table) {
    ...
    {
        Schema::table('pengeluaran_atk', function (Blueprint $table) {
            $table->dropForeign('pengeluaran_atk_atk_id_foreign');
            $table->dropForeign('pengeluaran_atk_satuan_id_foreign');
        });
    }
};
