<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="navbar-brand-wrapper d-flex align-items-center">
        <a class="navbar-brand brand-logo" href="#" style="pointer-events: none;">
        ...
        <a class="navbar-brand brand-logo-mini" href="#" style="pointer-events: none;">
            <img src="<?php echo e(asset('assets/images/logo-mini.png')); ?>" alt="logo" style="height: 40px; width: auto;">
        </a>
    </div>
            ...
            <li class="nav-item nav-profile dropdown">
                <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown"
                    ...
                    <div class="nav-profile-text">
                        <p class="mb-1 text-black"><?php echo e(auth()->user()->nama); ?></p>
                    </div>
                </a>
