    ...
    <div class="container py-4">
        <div class="card shadow-sm border-0 rounded-3">
            <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center py-3">
                ...
                <div class="d-flex">
                    <form method="GET" action="<?php echo e(route('laporan.export')); ?>" target="_blank" class="me-2">
                        <input type="hidden" name="bulan" value="<?php echo e($bulan); ?>">
                        <button class="btn btn-outline-secondary d-flex align-items-center">
                            <i class="bi bi-file-pdf me-2"></i> Export PDF
                        </button>
                    </form>
                    <form method="GET" action="<?php echo e(route('laporan.index')); ?>" class="d-flex">
                        ...
                        <div class="alert alert-light border-start border-5 border-primary mb-4 ps-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h4 class="mb-0">Rp <?php echo e(number_format($totalPemasukan, 0, ',', '.')); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="alert alert-light border-start border-5 border-danger mb-4 ps-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h4 class="mb-0">Rp <?php echo e(number_format($totalPengeluaran, 0, ',', '.')); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-hover table-striped">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $pemasukan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td><?php echo e(\Carbon\Carbon::parse($p->tanggal_masuk)->format('d/m/Y')); ?></td>
                                            <td><?php echo e($p->atk->nama_atk); ?></td>
                                            <td><?php echo e($p->jumlah); ?></td>
                                            <td><?php echo e($p->satuan->nama_satuan); ?></td>
                                            <td class="text-end">Rp <?php echo e(number_format($p->total_biaya, 0, ',', '.')); ?></td>
                                        </tr>
                            ...
                            <table class="table table-hover table-striped">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $pengeluaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td><?php echo e(\Carbon\Carbon::parse($p->tanggal_keluar)->format('d/m/Y')); ?></td>
                                            <td><?php echo e($p->atk->nama_atk); ?></td>
                                            <td><?php echo e($p->jumlah); ?></td>
                                            <td><?php echo e($p->satuan->nama_satuan); ?></td>
                                            <td class="text-end">Rp
                                                <?php echo e(number_format($p->jumlah * $p->harga_per_unit, 0, ',', '.')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\JIHAN DOC\Project Portofolio\atk-management\resources\views/laporan/index.blade.php ENDPATH**/ ?>