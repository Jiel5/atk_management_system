            ...
            <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                ...
                <div class="d-flex align-items-center gap-2">
                    <span class="badge bg-info-subtle text-info px-3 py-2 rounded-pill">
                        ...
                        Total: <?php echo e($pengeluaran->count()); ?> Transaksi
                    </span>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="card border-0 bg-danger bg-opacity-10 h-100">
                                <div class="card-body text-center p-3">
                                    ...
                                    <h6 class="fw-bold text-danger mb-1">Rp <?php echo e(number_format($totalPengeluaran, 0, ',', '.')); ?>
                        ...
                        <div class="col-md-4">
                            <div class="card border-0 bg-warning bg-opacity-10 h-100">
                                <div class="card-body text-center p-3">
                                    ...
                                    <h6 class="fw-bold text-warning mb-1"><?php echo e($totalItem); ?></h6>
                                    <small class="text-muted">
                                        Total Item Keluar
                                        <?php if(request('tanggal_mulai') || request('tanggal_selesai')): ?>
                                            <br><span class="badge bg-primary-subtle text-primary mt-1">Periode Terpilih</span>
                        ...
                        <div class="col-md-4">
                            <div class="card border-0 bg-info bg-opacity-10 h-100">
                                <div class="card-body text-center p-3">
                                    ...
                                    <h6 class="fw-bold text-info mb-1">Rp <?php echo e(number_format($rataRataHarga, 0, ',', '.')); ?></h6>
                                    <small class="text-muted">
                                        Rata-rata Harga
                                        <?php if(request('tanggal_mulai') || request('tanggal_selesai')): ?>
                                            <br><span class="badge bg-primary-subtle text-primary mt-1">Periode Terpilih</span>
                                ...
                                <tr class="border-bottom border-light">
                                    ...
                                    <td class="py-3">
                                        <span class="badge bg-success-subtle text-success px-3 py-2 rounded-pill">
                                            Rp <?php echo e(number_format($item->harga_per_unit, 0, ',', '.')); ?>

                                        </span>
                                    </td>
                                    <td class="py-3">
                                        <span class="fw-bold text-danger">
                                            Rp <?php echo e(number_format($item->jumlah * $item->harga_per_unit, 0, ',', '.')); ?>
                                    ...
                                    <td class="py-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span
                                                class="text-dark"><?php echo e(\Carbon\Carbon::parse($item->tanggal_keluar)->format('d/m/Y')); ?></span>
                                        </div>
                                    </td>
                                </tr>
                                    ...
                                    <td colspan="7" class="text-center py-5">
                                        <div class="d-flex flex-column align-items-center justify-content-center">
                                            ...
                                            <h6 class="text-muted mb-2">
                                                <?php echo e((request('tanggal_mulai') || request('tanggal_selesai')) ? 'Tidak Ada Data Pada Periode Tersebut' : 'Belum Ada Pengeluaran'); ?>

                                            </h6>
                                            <small class="text-muted">
                                                <?php echo e((request('tanggal_mulai') || request('tanggal_selesai')) ? 'Coba ubah filter tanggal atau reset filter' : 'Belum ada data pengeluaran ATK yang tercatat'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\JIHAN DOC\Project Portofolio\atk-management\resources\views/pengeluaran/index.blade.php ENDPATH**/ ?>