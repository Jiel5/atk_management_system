            ...
            <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                ...
                <div class="d-flex align-items-center gap-2">
                    <span class="badge bg-success-subtle text-success px-3 py-2 rounded-pill">
                        ...
                        Total: <?php echo e($pemasukan->count()); ?> Transaksi
                    </span>
                    <a href="<?php echo e(route('pemasukan.create')); ?>" class="btn btn-primary btn-sm rounded-pill px-3">
            ...
            <div class="card-body">
                            ...
                            <div class="mt-3">
                                <small class="text-muted">
                                    ...
                                    <?php elseif(request('tanggal_mulai')): ?>
                                        mulai dari <?php echo e(\Carbon\Carbon::parse(request('tanggal_mulai'))->format('d/m/Y')); ?>

                                    <?php elseif(request('tanggal_selesai')): ?>
                                        sampai <?php echo e(\Carbon\Carbon::parse(request('tanggal_selesai'))->format('d/m/Y')); ?>
                        ...
                        <div class="col-md-4">
                            <div class="card border-0 bg-success bg-opacity-10 h-100">
                                <div class="card-body text-center p-3">
                                    ...
                                    <h6 class="fw-bold text-success mb-1">Rp <?php echo e(number_format($totalPemasukan, 0, ',', '.')); ?>
                        ...
                        <div class="col-md-4">
                            <div class="card border-0 bg-info bg-opacity-10 h-100">
                                <div class="card-body text-center p-3">
                                    ...
                                    <h6 class="fw-bold text-info mb-1"><?php echo e($totalItem); ?></h6>
                                    <small class="text-muted">
                                        Total Item Masuk
                                        <?php if(request('tanggal_mulai') || request('tanggal_selesai')): ?>
                                            <br><span class="badge bg-primary-subtle text-primary mt-1">Periode Terpilih</span>
                        ...
                        <div class="col-md-4">
                            <div class="card border-0 bg-warning bg-opacity-10 h-100">
                                <div class="card-body text-center p-3">
                                    ...
                                    <h6 class="fw-bold text-warning mb-1">Rp <?php echo e(number_format($rataRataHarga, 0, ',', '.')); ?></h6>
                                    <small class="text-muted">
                                        Rata-rata Biaya
                                        <?php if(request('tanggal_mulai') || request('tanggal_selesai')): ?>
                                            <br><span class="badge bg-primary-subtle text-primary mt-1">Periode Terpilih</span>
                ...
                <div class="table-responsive">
                    <table class="table table-hover" id="tabelPemasukan">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $pemasukan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="border-bottom border-light">
                                    ...
                                    <td class="py-3">
                                        <span class="fw-bold text-dark"><?php echo e($item->jumlah); ?></span>
                                    </td>
                                    <td class="py-3">
                                    ...
                                    <td class="py-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="text-dark"><?php echo e(\Carbon\Carbon::parse($item->tanggal_masuk)->format('d/m/Y')); ?></span>
                                        </div>
                                    </td>
                                    <td class="py-3">
                                        <div class="d-flex justify-content-center gap-1">
                                            <?php if(!$item->sudah_dipakai): ?>
                                                <a href="<?php echo e(route('pemasukan.edit', $item->id)); ?>" 
                                                   class="btn btn-sm btn-warning rounded-pill px-3" 
                                                   data-bs-toggle="tooltip" title="Edit Data">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form action="<?php echo e(route('pemasukan.destroy', $item->id)); ?>" method="POST" class="d-inline">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <button type="submit" 
                                                            class="btn btn-sm btn-danger rounded-pill px-3"
                                                            data-bs-toggle="tooltip" title="Hapus Data"
                                                            onclick="return confirm('Yakin ingin menghapus data pemasukan <?php echo e($item->atk->nama_atk); ?>?')">
                                    ...
                                    <td colspan="7" class="text-center py-5">
                                        <div class="d-flex flex-column align-items-center justify-content-center">
                                            ...
                                            <h6 class="text-muted mb-2">
                                                <?php echo e((request('tanggal_mulai') || request('tanggal_selesai')) ? 'Tidak Ada Data Pada Periode Tersebut' : 'Belum Ada Pemasukan'); ?>

                                            </h6>
                                            <small class="text-muted">
                                                <?php echo e((request('tanggal_mulai') || request('tanggal_selesai')) ? 'Coba ubah filter tanggal atau reset filter' : 'Belum ada data pemasukan ATK yang tercatat'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\JIHAN DOC\Project Portofolio\atk-management\resources\views/pemasukan/index.blade.php ENDPATH**/ ?>