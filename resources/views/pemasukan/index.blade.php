            ...
            <div class="alert alert-info border-0 bg-info bg-opacity-10 mb-4">
                <div class="d-flex align-items-center">
                    ...
                    <small class="text-info mb-0">
                        <strong>Catatan:</strong> Tombol edit dan hapus akan <strong>nonaktif</strong> jika ATK sudah
                            ...
                            <tr class="border-bottom border-light">
                                ...
                                <td class="py-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span
                                            class="text-dark">{{ \Carbon\Carbon::parse($item->tanggal_masuk)->format('d/m/Y') }}</span>
                                    </div>
                                </td>
                                <td class="py-3">
                                    <div class="d-flex justify-content-center gap-1">
                                        @if(!$item->sudah_dipakai)
                                            <a href="{{ route('pemasukan.edit', $item->id) }}"
                                                class="btn btn-sm btn-warning rounded-pill px-3" data-bs-toggle="tooltip"
                                                title="Edit Data">
